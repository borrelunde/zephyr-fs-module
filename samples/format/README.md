# Zephyr File System Module Sample | Format

## Overview

Formats a file system volume using the module.
...
```
west build -p -b <board_name> samples\format
```

For example, to build for the nRF52840 Development Kit.

```
west build -p -b nrf52840dk_nrf52840 samples\format
```
